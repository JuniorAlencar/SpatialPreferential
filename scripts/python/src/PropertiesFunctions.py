...
def all_properties_dataframe_2():
    ...
    for root, dirs, files in os.walk(base_dir):
        ...
        if match:
            # Extrai os valores de N, dim, alpha_a e alpha_g a partir do nome da pasta
            ...
            if check_file:
                ...
                for i, file in enumerate(all_files):
                    ...
                    # Exibe o progresso
                    print(f"Processando: N={N_value}, dim={dim_value}, alpha_a={alpha_a_value}, alpha_g={alpha_g_value}")
                ...
                print(f"Arquivo não existe em N={N_value}, dim={dim_value}, alpha_a={alpha_a_value}, alpha_g={alpha_g_value}. Criando novo arquivo...")
